...
void set<T>::insert(T e) {
	if (!contains(e)) {
		if (contador == capacidad)
			amplia();
		// Modificacion sobre el metodo insert() proporcionado para conseguir una insercion ordenada
		//int pos = search(0, contador, e); // Busqueda binaria para encontrar la posicion de insercion
